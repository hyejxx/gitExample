...
public class StrMethod {
	public static void main(String[] args) {
		String str1 = "java";
		str1 += " programming"; //str1 = st1 + " programming", 문자열 연결이지만 
		//실제로 새로운 문자열 만들고 str1은 새로운 문자열의 주소값을 가리키게 된다.
		...
		System.out.println(str2.substring(0, 4)); //substring(start, end-1) => 0~3까지
		System.out.println(str2.substring(5)); //5~끝까지
		System.out.println(str2.replace("java", "jsp"));//java=>jsp
		System.out.println(str2);
		
		String str3 = "34820428394";
		System.out.println(str3.substring(5, 9)); //substring(start, end-1)
