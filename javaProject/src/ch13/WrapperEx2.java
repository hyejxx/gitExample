...
public class WrapperEx2 {
	public static void main(String[] args) {
		...
		//Integer
		System.out.println(Integer.parseInt("200")); //문자열 "200"을 10진수로 변환(숫자열)
		System.out.println(Integer.toString(200)); //정수를 문자열로 변환(toString)
		...
		System.out.println(d.toString()); //상수를 문자열로 변환
