...
public class ListMember {
	public static void main(String[] args) {
		...
		List<Member> list = new ArrayList<Member>(); //pdf제너릭과 컬렉션 7p참고
		...
		list.add(new Member("choi", "1234", "최철수", "02-132-3333", "choi@gmail.com"));
		System.out.println(list.size());
		
		System.out.println("이름\t아이디\t비번\t전번\t\t이메일");
