...
//에플릿뷰어나 웹브라우저와 함께 쓰였으며 게임 및 다양한 그래픽을 구사할 수 있다.
//현재는 HTML5등 웹이 진화되면서 거의 활동되지 않는다.
//라이프 사이클을 가지고 있다. init()-start()-stop()-destroy()
//init()은 필수처리이며 나머지는 자동으로 처리된다.

public class StringLine extends JApplet{ //StringLine 우클릭 -> Properties -> 자바에디터 -> 런디버그 세팅 -> -Dfile.encoding=MS949
